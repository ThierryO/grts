...
Note that the GRTS algorithm requires an equal number of levels in each dimension. In the case of `Spatial` objects, this is (internally) achieved by extending the bounding box of the grid as necessary.
